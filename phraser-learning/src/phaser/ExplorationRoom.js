...
export default class ExplorationRoom extends Phaser.Scene {
    constructor() {
        super('ExplorationRoom');
    }
    ...
    create() {
        ...
        this.add.rectangle(400, 300, 800, 600, 0xd1c4e9);
        
        this.add.text(400, 100, 'Welcome to the Exploration Room', {
            fontSize: '24px',
            fill: '#2c3e50',
            fontStyle: 'bold'
        }).setOrigin(0.5);

        this.add.text(400, 150, 'Discovery features coming soon:', {
            fontSize: '16px',
            fill: '#8e44ad'
        }).setOrigin(0.5);

        this.add.text(400, 200, '🔍 Knowledge Discovery\n📚 Learning Resources\n🧠 Idea Generation', {
            fontSize: '14px',
            fill: '#2c3e50',
            align: 'center'
        }).setOrigin(0.5);
